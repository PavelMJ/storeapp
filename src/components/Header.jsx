...
<<<<<<< HEAD
export default function Header({onCart, setSearchValue, serchValue }) {
	...
	return (
		...
		<div className='header'>
			...
			<div className='search'>
				<input className='inp' type="text" onChange={(event)=>{setSearchValue(event.target.value)}}/>
				<button className='srchBtn'>search</button>
				{serchValue && <img className='clearBtn' src="/img/ClearButton.svg" alt="clearbtn" />}
...
export default function Header({onCart}) {
	...
	return (
			...
			<div className='header'>
				...
				<svg onClick={()=>{onCart()}} className='cartIcon' width="56" height="52" viewBox="0 0 56 52" fill="none" xmlns="http://www.w3.org/2000/svg">
